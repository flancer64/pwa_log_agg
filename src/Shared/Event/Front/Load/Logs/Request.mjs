...
export default class Fl64_Log_Agg_Shared_Event_Front_Load_Logs_Request {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{data: Fl64_Log_Agg_Shared_Event_Front_Load_Logs_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}} [data]
         * @return {{data: Fl64_Log_Agg_Shared_Event_Front_Load_Logs_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}}
         */
